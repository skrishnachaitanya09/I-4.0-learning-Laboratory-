...
if((rlsrlt_sw2==0) && (srbsens==1)  && (hbslt_sw2==1) && (udsrllt_sw2==1))
{
  digitalWrite(11,HIGH);
  digitalWrite(12,HIGH); 
  digitalWrite(32,HIGH);
...
if((udsrllt_sw2==0) && (srbsens==1) && (hbslt_sw2==1) &&(rlsrlt_sw2==0))
{
  digitalWrite(26,HIGH);
  digitalWrite(24,HIGH);
  digitalWrite(36,HIGH);
...
if((udsrllt_sw2==0) && (srbsens==1) && (hbslt_sw2==0) &&(rlsrlt_sw2==0))
{
  digitalWrite(26,HIGH);
  digitalWrite(24,HIGH);
  digitalWrite(36,HIGH);
...
if((udsrllt_sw2==0) && (srbsens==1) && (hbslt_sw2==0) &&(rlsrlt_sw1==0))
{
  digitalWrite(26,HIGH);
  digitalWrite(24,LOW);
  digitalWrite(36,HIGH);
...
if((udsrrlt_sw2==0) && (srbsens==1) && (hbslt_sw2==0) &&(rlsrlt_sw1==0))
{
  digitalWrite(26,HIGH);
  digitalWrite(24,HIGH);
  digitalWrite(36,HIGH);
...
if((udsrrlt_sw2==0) && (srbsens==0) && (hbslt_sw2==0) &&(rlsrlt_sw2==0))
{
  digitalWrite(26,LOW);
  digitalWrite(24,HIGH);
  digitalWrite(36,HIGH);
