...
if((rlsrlt_sw2==0) && (srbsens==0)  && (hbslt_sw2==1) && (udsrrlt_sw1==1))
{
  digitalWrite(11,HIGH);
  digitalWrite(12,HIGH); 
  digitalWrite(32,HIGH);
...
if((udsrrlt_sw1==0) && (srbsens==0) && (hbslt_sw2==1))
{
  digitalWrite(26,HIGH);
  digitalWrite(24,HIGH);
  digitalWrite(36,HIGH);
...
if((hbslt_sw2==0) && (srbsens==0) && (udsrrlt_sw1==0) && (udsrllt_sw1==1))
{
  digitalWrite(36,HIGH);
  digitalWrite(34,HIGH);
  digitalWrite(26,HIGH);
...
//}
if((hbslt_sw2==0) && (rlsrlt_sw1==0) && (udsrrlt_sw1==0) && (srbsens==1))
{
  digitalWrite(26,LOW);
  digitalWrite(24,HIGH);
  digitalWrite(32,HIGH);
...
if((hbslt_sw2==0) && (rlsrlt_sw1==0) && (udsrllt_sw1==0) && (udsrrlt_sw1==1))
{
  digitalWrite(26,HIGH);
  digitalWrite(24,HIGH);
  digitalWrite(36,HIGH);
